        ...
        function Esp.CreateObject( player, typechar ) -- IMPORTANT!
            ...
            local Items = Data.Items; do
                ...
                -- Corner Boxes
                    ...
                    Items.BottomRightX = Esp:Create( "ImageLabel", {
                        ScaleType = Enum.ScaleType.Slice;
                        Parent = Items.Corners;
                        BorderColor3 = rgb(0, 0, 0);
                        Name = "\0";
        ...
        Library.ESPPreview = function(self, Data)
            ...
            local Items = { } do
                ...
                -- Corner boxes
                        ...
                        Items.BottomRightX = Instances:Create( "ImageLabel" , {
                            ScaleType = Enum.ScaleType.Slice;
                            Parent = Items.Corners.Instance;
                            BorderColor3 = FromRGB(0, 0, 0);
                            Name = "\0";
                        ...
                        Instances:Create( "UIGradient" , {
                            Parent = Items.BottomRightX.Instance
                        });

                        Items.BottomRightY = Instances:Create( "ImageLabel" , {
                            ScaleType = Enum.ScaleType.Slice;
                            Parent = Items.Corners.Instance;
                            BorderColor3 = FromRGB(0, 0, 0);
                            Name = "\0";
                        ...
                        Instances:Create( "UIGradient" , {
                            Rotation = 90;
                            Parent = Items.BottomRightY.Instance
                        });
